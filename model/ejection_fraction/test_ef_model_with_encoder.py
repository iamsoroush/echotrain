...
from .ef_model_with_encoder import EFModel_Encoder
import numpy
import os.path
...
def test_ef_estimation():
    ...
    ef_model_encoder = EFModel_Encoder(config_file)

    ed_frame = numpy.random.randn(112, 112, 1)
    es_frame = numpy.random.randn(112, 112, 1)
...
def test_train():
    ...
    assert os.path.exists(os.path.join(exported_dir, "exported", "en_to_v.sav"))
