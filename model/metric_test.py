...
class TestClass:
    ...
    def test_iou_coef(self, example_tensor_data):
        y_true, y_pred = example_tensor_data

        iou_value = get_iou_coef()(y_true, y_pred)
    ...
    def test_dice_coef(self, example_tensor_data):
        y_true, y_pred = example_tensor_data

        dice_value = get_dice_coeff()(y_true, y_pred)
    ...
    def test_hausdorff_distance(self, example_tensor_data):
        y_true, y_pred = example_tensor_data
    ...
    def test_get_mad(self, example_tensor_data):
        y_true, y_pred = example_tensor_data
        mad = get_mad(3, 3)(y_true, y_pred)
        print('mad:', mad)
        assert mad.shape == ()
        assert 'float' in str(mad.dtype)

    def test_get_soft_dice(self, example_tensor_data):
        y_true, y_pred = example_tensor_data

        soft_dice = get_soft_dice()(y_true, y_pred)
        print('soft_dice:', soft_dice)
        assert soft_dice.shape == ()
        assert 'float' in str(soft_dice.dtype)

    def test_get_soft_iou(self, example_tensor_data):
        y_true, y_pred = example_tensor_data

        soft_iou = get_soft_iou()(y_true, y_pred)
